...
class ProvenanceBookDiffHandler(NbdimeHandler):
    ...
    def get(self):
        ...
        args['base'] = base
        args['remote'] = base
        args['baseurl'] = 'provenancebookdiff'
...
def _load_jupyter_server_extension(nb_server_app):
    ...
    params = {
        'nbdime_relative_base_url': 'provenancebookdiff',
        'closable': False,
    }
    handlers = [
        (r'/provenancebookdiff/api/diff', ApiDiffHandler, params),
        (r'/provenancebookdiff', ProvenanceBookDiffHandler, params),
    ]
