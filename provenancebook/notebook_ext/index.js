// call "provenancebook" and compare versions in new tab
   ...
   // Add two toolbar buttons
    function add_toolbar_buttons () {        
        ...
        Jupyter.actions.register({
            ...
            handler : provenancebookDiffView
        }, 'provenance_diff_selected_cell_btn', 'provenancebookdiff'),
  		]));
	  }
    ...
    var provenancebookDiffView = function () {
        var cell = Jupyter.notebook.get_selected_cell();
        var cell_id = cell.cell_id;
    ...
    var getprovdiff = function (base_selected_execution, remote_selected_execution) {
        ...
        var url = window.location.origin + '/' + path_join(Jupyter.notebook.base_url, 'provenancebookdiff');
